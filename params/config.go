...
var (
	MainnetGenesisHash = common.HexToHash("0x2c42d7179f0dfc6c79fa51fba05cfcbe6a863d6c1eed78a8f1935d181caf3800") // enforce below configs on
	TestnetGenesisHash = common.HexToHash("0x053ff072089b581b732e71c2505bbfff55081b209ef28406d144c908baaf1ac1") // Testnet genesis hash to enforce below configs on
)
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		// master_main : 0x02DC2349521e0307Ed16A913c1800c82F3d5643E
		Chief006Block:   big.NewInt(3), // 3 is min num
		Chief006Address: common.HexToAddress("0x8aead5255b1d32dfd7bf39f33199b62fa2f0b6a5"),

		NR001Block: big.NewInt(0), // new rules for chief.tx of gaspool
		NR002Block: big.NewInt(18),
		NR003Block: big.NewInt(18),

		Register001Block:   big.NewInt(0),
		Register001Address: common.HexToAddress("0x"),

		TribemapBlock:   big.NewInt(5),
		TribemapAddress: common.HexToAddress("0x3199a5c8e285fe414a97b371595daa96590c9b80"),
	...
	TestnetChainConfig = &ChainConfig{
		...
		ByzantiumBlock: big.NewInt(0),
		// 0.0.6 : ready for release
		// master_test : 0x93Dd29e35729A407c77cF6Af9f44Cc567352c353
		Chief006Block:   big.NewInt(3),
		Chief006Address: common.HexToAddress("0xbb1118ca6f7e1eafd29108e064ffb19a761305d3"),
		// new rules for chief.tx of gaspool
		NR001Block: big.NewInt(1),
		NR002Block: big.NewInt(1),
		NR003Block: big.NewInt(1),

		Register001Block:   big.NewInt(0),
		Register001Address: common.HexToAddress("0x"),

		TribemapBlock:   big.NewInt(27),
		TribemapAddress: common.HexToAddress("0x4a521792699625df2ff6812491c932afcfcd2e84"),
...
type ChainConfig struct {
	...
	Register001Block   *big.Int       `json:"register001Block,omitempty"`
	Register001Address common.Address `json:"register001Address,omitempty"`

	TribemapBlock   *big.Int       `json:"tribemapBlock,omitempty"`
	TribemapAddress common.Address `json:"tribemapAddress,omitempty"`
