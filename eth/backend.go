...
import (
	...
	"github.com/IMTTHOLDINGCORP/go-aether/common/hexutil"
	...
	"github.com/IMTTHOLDINGCORP/go-aether/core/bloombits"
	...
	"github.com/IMTTHOLDINGCORP/go-aether/eth/filters"
	...
	"github.com/IMTTHOLDINGCORP/go-aether/miner"
...
func (s *Ethereum) tribeReadyForAcceptTxs() {
	...
	case <-params.TribeReadyForAcceptTxs:
		atomic.StoreUint32(&s.protocolManager.acceptTxs, 1)
		td := s.blockchain.GetTdByHash(s.blockchain.CurrentHeader().Hash())
		for _, p := range s.protocolManager.peers.peers {
			//p.td.Cmp(td)
			fmt.Println("==== ♨️ ====> ctd =", td, "ptd =", p.td, "pid =", p.id)
		}
	case <-s.shutdownChan:
		break
	}
