...
import (
	...
	"github.com/IMTTHOLDINGCORP/go-aether/accounts/keystore"
	"github.com/IMTTHOLDINGCORP/go-aether/common"
	"github.com/IMTTHOLDINGCORP/go-aether/consensus"
	"github.com/IMTTHOLDINGCORP/go-aether/consensus/clique"
	"github.com/IMTTHOLDINGCORP/go-aether/consensus/ethash"
	"github.com/IMTTHOLDINGCORP/go-aether/core"
	"github.com/IMTTHOLDINGCORP/go-aether/core/state"
	"github.com/IMTTHOLDINGCORP/go-aether/core/vm"
	"github.com/IMTTHOLDINGCORP/go-aether/dashboard"
	"github.com/IMTTHOLDINGCORP/go-aether/eth"
	"github.com/IMTTHOLDINGCORP/go-aether/eth/downloader"
	"github.com/IMTTHOLDINGCORP/go-aether/eth/gasprice"
	"github.com/IMTTHOLDINGCORP/go-aether/ethdb"
	"github.com/IMTTHOLDINGCORP/go-aether/ethstats"
	"github.com/IMTTHOLDINGCORP/go-aether/les"
	...
	"github.com/IMTTHOLDINGCORP/go-aether/p2p/discover"
	"github.com/IMTTHOLDINGCORP/go-aether/p2p/discv5"
	"github.com/IMTTHOLDINGCORP/go-aether/p2p/nat"
	"github.com/IMTTHOLDINGCORP/go-aether/p2p/netutil"
	"github.com/IMTTHOLDINGCORP/go-aether/params"
	whisper "github.com/IMTTHOLDINGCORP/go-aether/whisper/whisperv5"
...
func MakeAddress(ks *keystore.KeyStore, account string) (accounts.Account, error) {
	...
	log.Warn("Please use explicit addresses! (can search via `aether account list`)")
	log.Warn("-------------------------------------------------------------------")
...
// new format.
//
// e.g. aether account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// aether --keystore /tmp/mykeystore --lightkdf account new
//
