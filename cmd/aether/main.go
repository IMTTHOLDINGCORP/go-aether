...
import (
	...
	"github.com/IMTTHOLDINGCORP/go-aether/console"
	"github.com/IMTTHOLDINGCORP/go-aether/eth"
	"github.com/IMTTHOLDINGCORP/go-aether/ethclient"
	"github.com/IMTTHOLDINGCORP/go-aether/internal/debug"
...
const (
	clientIdentifier = "aether" // Client identifier to advertise over the network
)
...
var (
	...
	app = utils.NewApp(gitCommit, "the aether command line interface")
...
func init() {
	...
	app.Copyright = "Copyright 2019 The aether Author Beepay (Ethereum-based)"
...
func aether(ctx *cli.Context) error {
